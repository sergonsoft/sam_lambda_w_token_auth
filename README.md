...
This project enhance the SAM Hello World template with TOKEN authorizer lambda function. Along side the auth token name has been changed also.

The rest it a regular sam-app.
